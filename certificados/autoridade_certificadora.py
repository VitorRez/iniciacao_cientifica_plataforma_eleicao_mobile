...
def autoridade_certificadora(aut, reg, adm, val, tal):
    ...
    certificado('autoridade_certificadora', 'autoridade_certificadora', aut.chave.public_key().export_key("PEM"), "BR", "certificado_autoridade_eleitoral.pem", sign_aut_req)
    certificado('autoridade_certificadora', 'registrar', reg.chave.publickey().exportKey("PEM"), "BR", "certificado_registrar.pem", sign_reg_req)
    certificado('autoridade_certificadora', 'adminstrador', adm.chave.publickey().exportKey("PEM"), "BR", "certificado_administrator.pem", sign_adm_req)
    certificado('autoridade_certificadora', 'validator', val.chave.publickey().exportKey("PEM"), "BR", "certificado_validator.pem", sign_val_req)
    certificado('autoridade_certificadora', 'tallier', tal.chave.publickey().exportKey("PEM"), "BR", "certificado_tallier.pem", sign_tal_req)
